...
public class ReminderUtilities {
    ...
    private static final int REMINDER_INTERVAL_SECONS = 10;
    ...
    synchronized public static void scheduleChargingReminder(@NonNull final Context context) {
        ...
        Job job = dispatcher.newJobBuilder()
               ...
               // .setConstraints(Constraint.DEVICE_CHARGING)
                .setLifetime(FOREVER)
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(REMINDER_INTERVAL_SECONS,
                        REMINDER_INTERVAL_SECONS + SYNC_FLEXTIME_SECONDS))
