...
public class NotificationUtils {
    ...
    private static final int WATER_DISMISS_NOTIFICATION_ID = 1139;
    /**
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        Intent dismissReminderIntent = new Intent(context, WaterReminderIntentService.class);
        dismissReminderIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
        PendingIntent pendingIntent = PendingIntent.getService(context, WATER_DISMISS_NOTIFICATION_ID,
                dismissReminderIntent, PendingIntent.FLAG_UPDATE_CURRENT);

        return  new NotificationCompat.Action(
                R.drawable.ic_cancel_black_24px, "No, thanks", pendingIntent);
    }
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context, WATER_REMINDER_NOTIFICATION_ID,
                drinkWaterIntent, PendingIntent.FLAG_UPDATE_CURRENT);

        return  new NotificationCompat.Action(
                R.drawable.ic_local_drink_black_24px, "I dit it!", pendingIntent);
    }
