...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadSizeFromPreferences(SharedPreferences preferences) {
        float shapeSize = Float.parseFloat(preferences.getString(getString(R.string.pref_shape_size_key),
                getString(R.string.pref_shape_size_default)));
