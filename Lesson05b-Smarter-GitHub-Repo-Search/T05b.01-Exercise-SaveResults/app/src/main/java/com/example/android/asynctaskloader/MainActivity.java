...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String URL_QUERY = "URL_QUERY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(URL_QUERY)) {
                mUrlDisplayTextView.setText(savedInstanceState.getString(URL_QUERY));
            }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(URL_QUERY, url);

        String jsonResult = mSearchResultsTextView.getText().toString();
        outState.putString(RAW_JSON, jsonResult);
