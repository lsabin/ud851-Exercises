...
public class AddTaskActivity extends AppCompatActivity {
    ...
    public void onClickAddTask(View view) {
        ...
        String inputDescription = ((EditText) findViewById(R.id.editTextTaskDescription)).getText().toString();
        ...
        values.put(TaskContract.TaskEntry.COLUMN_DESCRIPTION, inputDescription);
