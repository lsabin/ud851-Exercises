...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        // Set the text of viewHolderIndexView to "ViewHolder index: " + viewHolderCount
        ...
        viewHolderCount++;
        Log.d(this.getClass().getSimpleName(), "onCreateViewHolder: ViewHolder count: " + viewHolderCount);
